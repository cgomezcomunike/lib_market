...
$fecha_ini = date("Y-m-d", time() - (60 * 60 * 24 * 365 * 3));
$fecha_fin = date("Y-m-d", time() - (60 * 60 * 24 * 365 * 5));

echo "SELECT * FROM `producto` WHERE `sub_dir` = '0' AND `campo_1` <> '0' AND `campo_1` <> '105732' id > '".$cursor."' AND campo_47 >= '".$fecha_fin."' AND campo_47 <= '".$fecha_ini."' ORDER BY `id` ASC LIMIT 10<br />";
$consulta = mysql_query("SELECT * FROM `producto` WHERE `sub_dir` = '0' AND `campo_1` <> '0' AND `campo_1` <> '105732' AND id > '".$cursor."' AND campo_47 >= '".$fecha_fin."' AND campo_47 <= '".$fecha_ini."' ORDER BY `id` ASC LIMIT 10",$db);
...
?>
<meta http-equiv="refresh" content="0; url=/v2_base/index.php?sub_cat=CV_migra_vehiculos_activos_3_5&cursorXX=<? echo $cursor ?>">
<?
