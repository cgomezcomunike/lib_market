...
// definimos el cursor
	...
	// armamos el listado de propectos
	                   echo "SELECT `id`, `campo_10`, `campo_26` FROM `suscripcion_post` WHERE `id` < '".$cursor."' AND `campo_10` != '' AND `campo_10` != '1111111111' AND `campo_10` != '111111111' AND `campo_10` != '11111111' AND `campo_10` != '1111111' AND `campo_26` != '' AND `id_dms` != 0 ORDER BY `id` DESC Limit 10<hr />";
    $consulta = mysql_query("SELECT `id`, `campo_10`, `campo_26` FROM `suscripcion_post` WHERE `id` < '".$cursor."' AND `campo_10` != '' AND `campo_10` != '1111111111' AND `campo_10` != '111111111' AND `campo_10` != '11111111' AND `campo_10` != '1111111' AND `campo_26` != '' AND `id_dms` != 0 ORDER BY `id` DESC Limit 10",$db);
...
//while(list($k, $v) = each($docs) ){
    ...
    $cliente = MEGA_mySQL_R("SELECT * FROM `suscripcion_post` WHERE `campo_10` = '".$celus[$k]."' ; ","id,campo_3,campo_5,campo_10,campo_26,campo_4,campo_24,campo_64",$modular_dir."/config/".$modular_ap_name_config.".php");
...
?>
<meta http-equiv="refresh" content="1; url=/v2_base/index.php?sub_cat=CV_migra_prospectos_desc&cursorXX=<? echo $cursor ?>">
<?
